/**
 * Comprehensive country list with ISO 3166-1 alpha-2 code, English name,
 * ITU-T E.164 dial code, and emoji flag. Alphabetical by name.
 *
 * Used by the PhoneInput component for the searchable country dropdown.
 * Add or remove rows as Affy's customer base shifts.
 */

export interface Country {
  iso: string;   // ISO 3166-1 alpha-2 (e.g. "PT")
  name: string;  // English name
  dial: string;  // E.164 country code with leading +
...
/** Pick a country by ISO code. */
export function countryByIso(iso: string): Country | undefined {
  return COUNTRIES.find((c) => c.iso === iso);
}

/**
 * Detect which country owns a "+NN..." prefix. Longest-match wins so +1242
 * (Bahamas) beats +1 (US). Returns undefined if no match.
 */
...
/** Filter helper used by the PhoneInput search field. */
